...
def run_unit_tests(debug=False) -> int:
    ...
    if return_code_unit_test_run == 0:
        console.rule(
            f"[{STYLE.HLGreen}][{STYLE.ITALIC}]Unit tests[/] [{STYLE.BOLD}]PASSED[/]."
        )
    else:
        console.rule(
    ...
    return_code_web_test_run = terminal(
        [
            "python",
            "nrobo.py",
            "--browser",
    ...
    if return_code_web_test_run == 0:
        console.rule(
            f"[{STYLE.HLGreen}][{STYLE.ITALIC}]Web tests[/] [{STYLE.BOLD}]PASSED[/]."
        )
    else:
        console.rule(
    ...
    return_code_mobile_android_device_test_run = terminal(
        [
            "python",
            "nrobo.py",
            "--appium",
            ...
            "http://localhost:4723",
            "--target",
            android_mobile_test_report_name,
            "--cap",
            "android_capability.yaml",
            "--files",
            "tests/mobile/appium/android",
        ],
        debug=debug,
        use_os_system_call=True,
    )
    if return_code_mobile_android_device_test_run == 0:
        console.rule(
            f"[{STYLE.HLGreen}][{STYLE.ITALIC}]Android Mobile tests[/] [{STYLE.BOLD}]PASSED[/]."
        )
    else:
        console.rule(
    ...
    return_code_mobile_ios_device_test_run = terminal(
        [
            "python",
            "nrobo.py",
            "--appium",
            ...
            "http://localhost:4723",
            "--target",
            ios_mobile_test_report,
            "--cap",
            "ios_capability.yaml",
            "--files",
            "tests/mobile/appium/ios",
        ],
        debug=debug,
        use_os_system_call=True,
    )
    if return_code_mobile_ios_device_test_run == 0:
        console.rule(
            f"[{STYLE.HLGreen}][{STYLE.ITALIC}]iOS Mobile tests[/] [{STYLE.BOLD}]PASSED[/]."
        )
    else:
        console.rule(
